<div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-7/12 lg:flex-none dosen">
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6 class="dark:text-white">Master dosen</h6>
                    @include('dashboard.dosen.create')
                </div>
                                    ...
                                    @foreach ($dosen as $u)
                                        <tr>
                                            ...
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-60">{{ $u->nip }}</span>
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
