<div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none prodi">
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6 class="dark:text-white">Master Prodi</h6>
                    @include('dashboard.prodi.create')
                </div>
                                ...
                                <tbody class="border-t">
                                    @foreach ($prodi as $u)
                                        <tr>
                                            ...
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                @include('dashboard.prodi.edit')
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-60">{{ $u->kode_prodi }}</span>
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-60">{{ $u->nama_prodi }}</span>
                                            </td>
