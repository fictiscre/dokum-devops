<div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none matkul">
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6 class="dark:text-white">Master matakuliah</h6>
                    @include('dashboard.matakuliah.create')
                </div>
                                ...
                                <tbody class="border-t">
                                    @foreach ($matakuliah as $u)
                                        <tr>
                                            ...
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                @include('dashboard.matakuliah.edit')
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-60">{{ $u->kode_matkul }}</span>
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-60">{{ $u->nama_matkul }}</span>
                                            </td>
